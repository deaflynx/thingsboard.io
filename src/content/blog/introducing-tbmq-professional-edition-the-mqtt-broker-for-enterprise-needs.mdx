...
We're excited to introduce [TBMQ Professional Edition](/docs/mqtt-broker/pe/) (TBMQ PE) – the next step in the evolution of our MQTT broker. TBMQ PE is built on top of [TBMQ's](https://tbmq.io/) proven, production-ready core and adds advanced features for security, observability, integration, and professional support. Starting with this release, the existing open-source version will be known as [TBMQ Community Edition](/docs/mqtt-broker/) (TBMQ CE).
...
Here's how the two editions align in terms of core features, security, extensibility, and support. See the [full comparison table](https://tbmq.io/#comparison-features).
