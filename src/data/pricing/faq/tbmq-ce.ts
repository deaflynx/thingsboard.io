		...
		items: [
			{
				...
				answer: `<p>The Community Edition includes all essential MQTT broker features with full support for MQTT 3.x and MQTT 5.0. You can find all features and descriptions <a target="_blank" href="${TBMQ_URLS.docs}" rel="noopener noreferrer">in the TBMQ documentation</a>.</p>`,
			},
			{
				id: 'tbmq-ce-pe-exclusive',
				question: 'What features are exclusive to the Professional Edition?',
				answer: `<p>The Professional Edition offers advanced features such as White Labeling, RBAC, Single sign-on, etc. You can find a more detailed comparison <a target="_blank" href="${TBMQ_URLS.product}" rel="noopener noreferrer">on the TBMQ product page</a>.</p>`,
			},
			{
		...
		items: [
			{
				...
				answer: `<p>The TBMQ team does not provide dedicated support for Community Edition users. However, users can access community-driven resources such as <a target="_blank" href="https://github.com/thingsboard/tbmq/issues" rel="noopener noreferrer">GitHub Issues</a>, <a target="_blank" href="${TBMQ_URLS.docs}" rel="noopener noreferrer">documentation</a>, and <a target="_blank" href="https://github.com/thingsboard/tbmq" rel="noopener noreferrer">GitHub</a> for assistance.</p>`,
			},
			{
				id: 'tbmq-ce-paid-support',
				question: 'Can I purchase additional support for the Community Edition?',
				answer: '<p>Depending on the type of support you are looking for, the TBMQ team may be able to offer certain types of additional support packages. To discuss your unique case and requirements, please <a target="_blank" href="/contact-us/?subject=TBMQ" rel="noopener noreferrer">contact us</a>.</p>',
			},
			{
				id: 'tbmq-ce-help',
				question: 'Where can I get help if I run into issues?',
				answer: `<p><a target="_blank" href="https://github.com/thingsboard/tbmq/issues" rel="noopener noreferrer">GitHub</a> (report issues, contribute)<br><a target="_blank" href="https://stackoverflow.com/questions/tagged/thingsboard" rel="noopener noreferrer">Stack Overflow</a> (for developer-related questions)<br><a target="_blank" href="${TBMQ_URLS.docs}" rel="noopener noreferrer">Documentation & Tutorials</a></p>`,
			},
			{
			...
			},
			{
				...
				answer: '<p>The TBMQ team can propose application configuration services. To discuss your unique case and requirements, please <a target="_blank" href="/contact-us/?subject=TBMQ" rel="noopener noreferrer">contact us</a>.</p>',
			},
			{
				id: 'tbmq-ce-updates',
			...
			},
			{
				...
				answer: '<p>Yes, you can request such assistance as an additional paid service. Please, <a target="_blank" href="/contact-us/?subject=TBMQ" rel="noopener noreferrer">contact us</a> to discuss how we can help.</p>',
			},
			{
	...
	},
	{
		...
		items: [
			...
			},
			{
				...
				answer: '<p>Migration depends on factors such as the version, source code changes, and more. Please <a target="_blank" href="/contact-us/?subject=TBMQ" rel="noopener noreferrer">contact us</a> for personalized suggestions and a clear strategy on how to perform the migration.</p>',
			},
			{
				id: 'tbmq-ce-pe-trial',
